...
#python train.py --trainRoot /home/znlh/dnn/baochaoqian/test/crnn.pytorch-master/data/train_lmdb   --valRoot /home/znlh/dnn/baochaoqian/test/crnn.pytorch-master/data/val_lmdb  --random_sample True
...
parser.add_argument('--saveInterval', type=int, default=40, help='Interval to be displayed')
...
def val(net, dataset, criterion, max_iter=100):
    ...
    accuracy = n_correct / float(totalNum)
...
def trainBatch(net, criterion, optimizer):
    ...
    #buf.write(cpu_images[0])   #指针对象写入数据
    #buf.seek(0)
    #img.show()
    ...
    #sim_preds = converter.decode(preds1.data, preds_size.data, raw=False)
    #print(sim_preds,cpu_texts)
    cost = criterion(preds, text, preds_size, length) / batch_size
    crnn.zero_grad()
    cost.backward()
    optimizer.step()
